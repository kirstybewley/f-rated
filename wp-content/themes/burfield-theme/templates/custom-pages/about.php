...
<main role="main">
  ...
  <section>
    <div class="row island-quatcolor">
      <div class="col-12 col-6-m island island-quatcolor">
        ...
        <div class="col-12 col-6-m no-padding">
          <img src="<?php echo get_template_directory_uri(); ?>/img/rated/about.jpg" alt="" />
        </div>
    </div>

    <div class="row island-quatcolor">
      <div class="col-12 col-6-m float-right island island-quatcolor">
  ...
  <section class="timeline">
    <div class="row">
      <div class="col-12 island text-center">
        <div class="title"><h2>RISE OF THE F-RATING</h2></div>
        <div class="line-down"></div>

        <div class="time-text island col-12 col-6-m clear">
        ...
        <div class="time-text island col-12 col-6-m clear float-right">
